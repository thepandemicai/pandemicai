  ...
  return (
    <div className='relative flex flex-col h-screen text-white'>
      ...
      <div className='fixed top-1/4 bg-black bg-opacity-50 right-2 p-2 md:p-4 rounded flex flex-col gap-6 md:gap-10'>
        <Link href="https://github.com/thepandemicai/pandemic-ai"><img src='https://i.postimg.cc/bvBzL4mD/x.png' alt='twitter' width={30} height={30} className="md:w-[40px] md:h-[40px]"/></Link>
        <Link href="#"><img src='https://i.postimg.cc/NjQf06yM/github.png' alt='github' width={30} height={30} className="md:w-[40px] md:h-[40px]"/></Link>
      </div>
    </div>
  );
};
